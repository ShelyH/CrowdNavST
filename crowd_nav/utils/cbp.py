...
class CompactBilinearPooling(nn.Module):
    ...
    def __init__(self, input_dim1, input_dim2, output_dim, sum_pool=True, cuda=False,
        ...
        # print(self.sparse_sketch_matrix1)
        if rand_h_2 is None:
            np.random.seed(5)
    ...
    def forward(self, bottom1, bottom2):
        ...
        # print(bottom1.shape, bottom2.shape)
        batch_size, _, human_num, feature_size = bottom1.size()
        # print(bottom1.size())
        ...
        # print(self.sparse_sketch_matrix1.shape)
        ...
        cbp = cbp_flat.view(batch_size, human_num, feature_size, self.output_dim)
        # print(cbp.shape)  # torch.Size([1, 2, 12, 12])
        # print(cbp)
        if self.sum_pool:
            cbp = cbp.sum(dim=-1)
        # print(cbp.shape)
    ...
    def generate_sketch_matrix(rand_h, rand_s, output_dim):
        ...
        # print(sparse_sketch_matrix.to_dense())
