...
def main():
    ...
    parser.add_argument("--env_id", type=str, default="CrowdSim-v1", help="Environment Id")
    parser.add_argument('--output_dir', type=str, default='crossTF99.6%/output')
    ...
    for episode in range(num_updates):
        ...
        while not done:
            ...
            next_state = JointState(env.get_robot_states(), next_state)
